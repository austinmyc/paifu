...
- [ ] Energy efficiency — average attack cost
- [ ] One-shot thresholds — what HP ranges can the deck OHKO
- [ ] Prize mapping — prize trade analysis (ex gives 2, basic gives 1)
- [ ] Consistency counts — searchers, draw supporters, energy acceleration
- [ ] Disruption counts — hand disruption, item lock, energy removal
