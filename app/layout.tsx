  ...
  return (
    <html lang="zh-HK" className={`${geistSans.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col">
        {children}
        <Toaster />
        <footer className="mt-auto px-4 py-3 text-xs flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-4 items-center" style={{ color: "rgba(110,125,150,0.75)", borderTop: "1px solid rgba(110,125,150,0.15)" }}>
          ...
          <p className="flex-shrink-0">
            ...
            <a
              ...
              style={{ color: "rgba(110,125,150,0.95)" }}
            >
              歡迎提交回報
            </a>
          </p>
